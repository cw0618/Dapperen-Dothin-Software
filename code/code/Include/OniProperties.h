...
namespace openni
{
    ...
    enum
    {
        ...
        DEVICE_PROPERTY_FREQUENCY_MODE = 6,
        DEVICE_PROPERTY_SENSOR_ID = 7,
        DEVICE_PROPERTY_PLATFORM_VERSION = 8,
        DEVICE_PROPERTY_GENERAL_SERIAL_NUMBER = 9,
        DEVICE_PROPERTY_SEND_COMMAND = 10,
        DEVICE_PROPERTY_EMITTER_STATE = 50,
        DEVICE_PROPERTY_LOAD_FILE = 51,
        DEVICE_PROPERTY_CALIBRATION_CAMERA = 52,
        DEVICE_PROPERTY_QUERY_DEVICE_TIMESTAMP = 53,
        DEVICE_PROPERTY_START_SERVICE = 54,
        DEVICE_PROPERTY_TEMPERATURE_COEFFICIENT_RX = 55,
