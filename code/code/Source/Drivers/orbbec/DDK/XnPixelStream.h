...
public:
    ...
    inline XnUInt32 GetMetadataLine() const { return (XnUInt32)m_metadataLine.GetValue(); }
...
protected:
    ...
    virtual XnStatus SetMetadataLine(XnUInt32 line);
...
private:
    ...
    static XnStatus XN_CALLBACK_TYPE SetMetadataLineCallback(XnActualIntProperty* pSenser, XnUInt64 nValue, void* pCookie);
    ...
    XnActualIntProperty m_metadataLine;
