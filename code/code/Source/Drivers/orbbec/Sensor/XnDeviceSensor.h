...
#define XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE 4096 /*2048*//*336*/
#define XN_DEVICE_SENSOR_10_BIT_MAX_SHIFT_VALUE 1024

#define XN_DEVICE_SENSOR_MAX_IR 1023
#define XN_DEVICE_SENSOR_MAX_PHASE UINT16_MAX

#define XN_DEVICE_SENSOR_MAX_AI UINT16_MAX
...
#define XN_MASK_SENSOR_PROTOCOL_PHASE    XN_MASK_SENSOR_PROTOCOL "Phase"
#define XN_MASK_SENSOR_PROTOCOL_AI       XN_MASK_SENSOR_PROTOCOL "AI"
...
typedef struct XnDevicePrivateData
{
    ...
    XnSpecificUsbDevice* pSpecificAIUsb;
