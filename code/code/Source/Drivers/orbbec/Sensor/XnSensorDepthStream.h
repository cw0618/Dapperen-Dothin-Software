...
public:
    ...
    XnIODepthFormats GetInputFormat() { return (XnIODepthFormats)m_InputFormat.GetValue(); }

	friend class XnDepthProcessor;
	friend class XnOniDepthStream;

public:
    const XnActualIntProperty& GetFirmwareCropMode() { return m_FirmwareCropMode; }
    const XnActualIntProperty& GetFirmwareCropSizeX() { return m_FirmwareCropSizeX; }
    const XnActualIntProperty& GetFirmwareCropSizeY() { return m_FirmwareCropSizeY; }
    const XnActualIntProperty& GetFirmwareCropOffsetX() { return m_FirmwareCropOffsetX; }
    const XnActualIntProperty& GetFirmwareCropOffsetY() { return m_FirmwareCropOffsetY; }
    const XnActualIntProperty& GetFirmwareInputFormat() { return m_InputFormat; }
...
protected:
    ...
    virtual XnStatus GetRegistration(OniImageRegistrationMode* pMode);
...
private:
    ...
    static XnStatus XN_CALLBACK_TYPE GetRegistrationCallback(const XnActualIntProperty* pSender, XnUInt64* pValue, void* pCookie);
