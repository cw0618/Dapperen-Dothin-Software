...
#pragma pack(push, 1)
    typedef struct
    {
        ...
        XnFloat temperDelay;
        XnFloat dutyCycle[2];
        XnUInt16 frequency[2];
        XnUInt16 intergration[2];
    } Metadata;
#pragma pack(pop)
...
protected:
    ...
    */
    ...
    /*
    * Parsing metadata called when a frame ends.
    *
    * @param    pData    [in]     A pointer to the raw data.
    * @param    pMeta    [out]    A pointer to store metadata.
    */
    virtual void ProcessMetadata(OniMetadata* pMeta, const XnUInt8* pData);
    ...
    */
    ...
    void Channel2Rotate90(const unsigned char* src, int src_stride,
