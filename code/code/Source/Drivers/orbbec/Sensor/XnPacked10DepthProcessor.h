...
*									     *
*****************************************************************************/
#ifndef XNPACKED10DEPTHPROCESSOR_H
#define XNPACKED10DEPTHPROCESSOR_H
...
class XnPacked10DepthProcessor : public XnDepthProcessor
{
public:
	XnPacked10DepthProcessor(XnSensorDepthStream* pStream, XnSensorStreamHelper* pHelper, XnFrameBufferManager* pBufferManager);
	virtual ~XnPacked10DepthProcessor();
...
protected:
	...
	// Internal Functions
	//---------------------------------------------------------------------------
	XnStatus Unpack10to16(const XnUInt8* pcInput, const XnUInt32 nInputSize, XnUInt32* pnActualRead);
