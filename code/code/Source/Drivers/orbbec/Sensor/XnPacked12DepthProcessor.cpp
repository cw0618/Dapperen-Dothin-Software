...
XnStatus XnPacked12DepthProcessor::Unpack12to16(const XnUInt8* pcInput, const XnUInt32 nInputSize, XnUInt32* pnActualRead)
{
	...
	*pnActualRead = 0;
	...
	for (XnUInt32 nElem = 0; nElem < nElements; ++nElem)
	{
		...
		shift[0] = (((shift[0]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[0]) : 0);
		shift[1] = (((shift[1]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[1]) : 0);
		shift[2] = (((shift[2]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[2]) : 0);
		shift[3] = (((shift[3]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[3]) : 0);
		shift[4] = (((shift[4]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[4]) : 0);
		shift[5] = (((shift[5]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[5]) : 0);
		shift[6] = (((shift[6]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[6]) : 0);
		shift[7] = (((shift[7]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[7]) : 0);
		shift[8] = (((shift[8]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[8]) : 0);
		shift[9] = (((shift[9]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[9]) : 0);
		shift[10] = (((shift[10]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[10]) : 0);
		shift[11] = (((shift[11]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[11]) : 0);
		shift[12] = (((shift[12]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[12]) : 0);
		shift[13] = (((shift[13]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[13]) : 0);
		shift[14] = (((shift[14]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[14]) : 0);
		shift[15] = (((shift[15]) < (XN_DEVICE_SENSOR_12_BIT_MAX_SHIFT_VALUE - 1)) ? (shift[15]) : 0);
