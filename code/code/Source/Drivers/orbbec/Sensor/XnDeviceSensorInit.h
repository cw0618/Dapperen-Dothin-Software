...
//---------------------------------------------------------------------------
    ...
    #define XN_SENSOR_USB_BODY_BUFFER_SIZE_MULTIPLIER_ISO               8*10
    #define XN_SENSOR_USB_BODY_BUFFER_SIZE_MULTIPLIER_BULK              120
    #define XN_SENSOR_USB_BODY_BUFFER_SIZE_MULTIPLIER_LOWBAND_ISO       8*5
    #define XN_SENSOR_USB_BODY_BUFFERS                                  8
    ...
    #define XN_SENSOR_USB_BODY_BUFFER_SIZE                              0x4000
    #define XN_SENSOR_USB_BODY_BUFFERS                                  2
    ...
    #define XN_SENSOR_USB_IMAGE_BUFFER_SIZE_MULTIPLIER_BULK             160
    ...
    #define XN_SENSOR_USB_DEPTH_BUFFER_SIZE_MULTIPLIER_BULK             160
    ...
    #define XN_SENSOR_USB_BODY_BUFFER_SIZE_MULTIPLIER_ISO               32
    #define XN_SENSOR_USB_BODY_BUFFER_SIZE_MULTIPLIER_BULK              160
    #define XN_SENSOR_USB_BODY_BUFFER_SIZE_MULTIPLIER_LOWBAND_ISO       16
    #define XN_SENSOR_USB_BODY_BUFFERS                                  16
#endif
