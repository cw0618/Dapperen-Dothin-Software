...
public:
    ...
    inline void MarkPhase(XnUInt32 nFrameID, XnUInt64 nTS) { Mark(&m_phase, "PhaseInput", nFrameID, nTS); }
    inline void MarkBody(XnUInt32 nFrameID, XnUInt64 nTS) { Mark(&m_body, "BodyInput", nFrameID, nTS); }
private:
