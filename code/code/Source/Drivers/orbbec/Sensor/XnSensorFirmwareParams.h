...
public:
    ...
    XnActualIntProperty m_Stream3Mode;
    ...
    /// AI
    XnActualIntProperty m_AIFPS;
    XnActualIntProperty m_AIFormat;
    XnActualIntProperty m_AIMirror;
    XnActualIntProperty m_AIResolution;

    /// Phase
    XnActualIntProperty m_phaseFPS;
    XnActualIntProperty m_phaseFormat;
    XnActualIntProperty m_phaseMirror;
    XnActualIntProperty m_phaseResolution;
    XnActualIntProperty m_phaseCropMode;
    XnActualIntProperty m_phaseCropSizeX;
    XnActualIntProperty m_phaseCropSizeY;
    XnActualIntProperty m_phaseCropOffsetX;
    XnActualIntProperty m_phaseCropOffsetY;
