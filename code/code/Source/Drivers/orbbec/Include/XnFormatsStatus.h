...
XN_STATUS_MESSAGE(XN_STATUS_IO_INVALID_STREAM_IR_FORMAT, "Invalid Xiron I/O stream ir format!")
XN_STATUS_MESSAGE(XN_STATUS_IO_INVALID_STREAM_PHASE_FORMAT, "Invalid Xiron I/O stream phase format!")
XN_STATUS_MESSAGE(XN_STATUS_IO_INVALID_STREAM_AI_FORMAT, "Invalid Xiron I/O stream AI format!")
