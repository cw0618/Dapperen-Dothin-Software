...
public:
	...
	virtual OniStatus convertC2DCoordinates( int colorX, int colorY, OniDepthPixel depthZ, int* pDepthX, int* pDepthY);
	virtual OniStatus convertD2CCoordinates( int depthX, int depthY, OniDepthPixel depthZ, int* pColorX, int* pColorY);
};
