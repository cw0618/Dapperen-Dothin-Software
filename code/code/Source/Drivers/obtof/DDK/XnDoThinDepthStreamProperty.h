#pragma once
#ifndef XN_DOTHIN_DEPTH_STREAM_PROPERTIES
#define XN_DOTHIN_DEPTH_STREAM_PROPERTIES
...
class XnDothinDepthStreamProperty : public  XnDothinStreamProperties
{
public:
    XnDothinDepthStreamProperty(XnChar* strType, OniSensorType sensorType, XnUInt32 sensorId);

    virtual ~XnDothinDepthStreamProperty();
...
private:
	const XnChar* XN_MASK_DOTHIN_DEPTH_STREAM_PROP = "DothinDepthStreamProperty";
    XnUInt32 m_sensorId;
...
#endif //XN_DOTHIN_DEPTH_STREAM_PROPERTIES
