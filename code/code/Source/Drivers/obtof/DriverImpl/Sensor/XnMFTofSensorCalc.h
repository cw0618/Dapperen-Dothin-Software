...
#ifndef __XN_MF_TOF_SENSOR_CALC_H_
#define __XN_MF_TOF_SENSOR_CALC_H_

#include "XnMFTofSensor.h"

#define XN_MASK_MF_TOF_SENSOR_CALC "MFTofSensorCalc"

class XnMFTofSensorCalc : public XnMFTofSensor
{
public:
    XnMFTofSensorCalc(mx6x_module_t *mx6xModule);

    virtual ~XnMFTofSensorCalc();
...
#endif//__XN_MF_TOF_SENSOR_CALC_H_
