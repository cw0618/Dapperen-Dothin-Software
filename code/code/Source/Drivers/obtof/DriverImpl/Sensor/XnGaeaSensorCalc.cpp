...
XnGaeaSensorCalc::XnGaeaSensorCalc(mx6x_module_t *mx6xModule) :
XnGaeaSensor(mx6xModule)
{
...
XnGaeaSensorCalc::~XnGaeaSensorCalc()
{
    m_configFilePathAndName = nullptr;
    m_calibFilePathAndName = nullptr;
}

XnStatus XnGaeaSensorCalc::UpdateFrameInfo(OniFrame *frame)
{
...
XnStatus XnGaeaSensorCalc::CalcSensorProperty()
{
	XnGaeaSensor::CalcSensorProperty();
...
XnStatus XnGaeaSensorCalc::UpdateMode()
{
	XnStatus nRet = XN_STATUS_OK;

	nRet = XnGaeaSensor::UpdateMode();
...
XnStatus XnGaeaSensorCalc::UpdateCalcConfig()
{
...
XnStatus XnGaeaSensorCalc::GetOutputbufferSize(XnUInt32 *outputBufferWidth, XnUInt32 *outputBufferHeight, XnUInt32 *outputBufferSize)
{
...
XnStatus XnGaeaSensorCalc::GetOutputImageSize(XnUInt32 *outputImageWidth, XnUInt32 *outputImageHeight, XnUInt32 *outputImageSize)
{
...
int XnGaeaSensorCalc::getWidth(){
	return kVGADepthWidth;
}
int XnGaeaSensorCalc::getHeight(){
