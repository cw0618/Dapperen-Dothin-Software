...
*  @project   :
*  @file      :
*  @brief     :    支持MF2202 tof sensor 深度图、幅值图、强度图的计算
*  @author    :    
*  @version   :    
*  @date      :    2022.06.21 0                                                                *
*                                                                                             *
...
#ifndef __XN_GAEA_TOF_SENSOR_CALC_H_
#define __XN_GAEA_TOF_SENSOR_CALC_H_

#include "XnGaeaSensor.h"

#define XN_MASK_MF_TOF_SENSOR_CALC "MFTofSensorCalc"

class XnGaeaSensorCalc : public XnGaeaSensor
{
public:
    XnGaeaSensorCalc(mx6x_module_t *mx6xModule);

    virtual ~XnGaeaSensorCalc();
...
#endif//__XN_GAEA_TOF_SENSOR_CALC_H_
