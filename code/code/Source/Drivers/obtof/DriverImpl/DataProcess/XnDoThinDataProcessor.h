...
public:
    ...
    virtual void  XnDothinFrameDataCallback(XnChar* grabBuffer, XnUInt32 grabBufferSize, XnUInt32 requiredFrameSize);

	/*pBufferSize：Unpack buffer size*/
    virtual XnStatus XnDothinFrameProcess(XnChar* grabBuffer, XnUInt32 grabBufferSize, XnUInt32 requiredFrameSize);
