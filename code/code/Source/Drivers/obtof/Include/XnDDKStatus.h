...
XN_STATUS_MESSAGE(XN_STATUS_IO_DEVICE_NOT_WRITE_PUBLIC_KEY, "not write public key!")
XN_STATUS_MESSAGE(XN_STATUS_IO_DEVICE_PUBLIC_KEY_MD5_VERIFY_FAIL, "public key md5 verify failed!")
XN_STATUS_MESSAGE(XN_STATUS_IO_DEVICE_NOT_WRITE_MD5, "not write md5!")
XN_STATUS_MESSAGE(XN_STATUS_IO_DEVICE_RSKEY_VERIFY_FAIL, "rs key verify fail!")
