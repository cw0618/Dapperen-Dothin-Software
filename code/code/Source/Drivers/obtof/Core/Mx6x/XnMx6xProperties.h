...
typedef enum mx6x_command{
	...
	DELAY_POWER = 300,        //延时电路板电源开关 unsigned 8bit
	DELAY_FW_VERSION = 301,   //延时电路固件版本 unsigned 8bit
	DELAY_DELAY_SWITCH = 302, //延时电路延时开关 unsigned 8bit
	DELAY_DELAY_TIME = 303,   //延时电路延时时间 unsigned 32bit
	DELAY_TEMPERATURE = 304,  //延时电路温度 @see DelayBoardTemperature
	PHASE_COUNT = 310,     //一个帧组多少个相位
