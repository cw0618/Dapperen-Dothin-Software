...
void XnDothinDataProcessor::XnDothinFrameDataCallback(XnUChar* grabBuffer, XnUInt32 grabBufferSize, XnUInt32 requiredFrameSize)
{
...
XnStatus XnDothinDataProcessor::XnDothinFrameProcess(XnUChar* dBuffer, XnUInt32 nBufferSize, XnUInt32 pBufferSize)
{
	return XN_STATUS_OK;
}
