#ifndef XN_MX6X_OBCTEE_FUNS
#define XN_MX6X_OBCTEE_FUNS
...
extern "C"{
	...
	typedef int(*func_ptr_int_uint8p_uint32)(uint8_t * buf, XnUInt32 size);
	typedef void(*func_ptr_void_uint64)(XnUInt32 usec);
    ...
    typedef int(*func_ptr_int_uint8p_uint16)(const uint8_t* pbuffer, const uint16_t size, const XnUInt32 dev_id);
