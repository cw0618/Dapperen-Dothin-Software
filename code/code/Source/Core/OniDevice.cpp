...
OniStatus Device::setProperty(int propertyId, const void* data, int dataSize)
{
...
OniStatus Device::getProperty(int propertyId, void* data, int* pDataSize)
{
...
OniBool Device::isPropertySupported(int propertyId)
{
