...
struct Funcs
{
	...
	OniStatus (ONI_C_DECL* oniDriverStreamConvertC2DCoordinates)(void* depthStreamHandle,  int colorX, int colorY, OniDepthPixel depthZ, int* pDepthX, int* pDepthY);
	OniStatus (ONI_C_DECL* oniDriverStreamConvertD2CCoordinates)(void* depthStreamHandle,  int depthX, int depthY, OniDepthPixel depthZ, int* pColorX, int* pColorY);
...
#ifdef FREE_SELINUX
    void (ONI_C_DECL* oniDriverSetUsbParam)(int fd, const char* usbpath);
#endif
};
...
public:
	...
	OniStatus convertPointC2D(void* depthStreamHandle,  int colorX, int colorY, OniDepthPixel DepthZ, int* pDepthX, int* pDepthY) const
	{
		return (*funcs.oniDriverStreamConvertC2DCoordinates)(depthStreamHandle,  colorX, colorY, DepthZ, pDepthX, pDepthY);
	}

	OniStatus convertPointD2C(void* depthStreamHandle,  int depthX, int depthY, OniDepthPixel DepthZ, int* pColorX, int* pColorY) const
	{
		return (*funcs.oniDriverStreamConvertD2CCoordinates)(depthStreamHandle,  depthX, depthY, DepthZ, pColorX, pColorY);
	}
...
#ifdef FREE_SELINUX
        void SetUsbParam(int fd, const char* usbpath) const 
	{
               return (*funcs.oniDriverSetUsbParam)(fd,usbpath);
	}
#endif
private:
	Funcs funcs;
