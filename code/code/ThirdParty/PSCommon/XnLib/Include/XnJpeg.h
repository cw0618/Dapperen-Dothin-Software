...
XnStatus XnStreamUncompressImjpegToYUYV(const XnUInt8* pInput, const XnUInt32 nInputSize, XnUInt8* pOutput, XnUInt32* pnOutputSize, XnUInt32 XRes, XnUInt32 YRes);
