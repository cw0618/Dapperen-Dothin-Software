 ...
 * {@link VideoStream#readFrame()}. Please note that the returned frame
...
public class VideoFrameRef {
    ...
    private ExtraMetaData mMetaData;
     ...
     * {@link Device#setDepthColorSyncEnabled(boolean)}, then frame numbers for
    ...
    /**
     * Returns a reference to the {@link ExtraMetaData} object assigned to this frame. This object
     * describes the extra meta data when the frame was produced.
     *
     * @return Reference to the {@link ExtraMetaData} assigned to this frame.
     */
    public final ExtraMetaData getExtraMetaData() {
        return mMetaData;
    }
    ...
    public String toString() {
        return "Video Frame{ " +
                ...
                ", width=" + mHeight +
                ", stride=" + mStride +
                ", cropping=" + mIsCropping +
                ", cropping x=" + mCropOrigX +
                ", cropping y=" + mCropOrigY +
                ", timestamp=" + mTimestamp +
                ", frame handle=" + mFrameHandle +
                ", data=" + mData +
                ", " + mVideoMode.toString() +
                ", " + mMetaData.toString() +
                " }";
