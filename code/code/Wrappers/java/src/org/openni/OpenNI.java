...
public class OpenNI {
     ...
     * {@link OpenNI#addDeviceConnectedListener(DeviceConnectedListener)}
     ...
     * {@link OpenNI#removeDeviceConnectedListener(DeviceConnectedListener)}
    ...
    public interface DeviceConnectedListener {
         ...
         * reconnected. Once a device was reconnected, {@link Device#open(String)} should be
         ...
         * {@link Device#open(String)} function.
         */
     ...
     * {@link Device#open(String)} should be called again in order to use this device.
     * <p>
     * To use this class, you should write a new class that inherits from it, and override the
     * onDeviceDisconnected method. Once you instantiate your class, use the
     * {@link OpenNI#addDeviceDisconnectedListener(DeviceDisconnectedListener)}
     * function to add your listener object to OpenNI's list of listeners. Your handler function will
     * then be called whenever the event occurs. A
     * {@link OpenNI#removeDeviceDisconnectedListener(DeviceDisconnectedListener)}
     * function is also provided, if you want to have your class stop listening to these events for
     * any reason.
     */
    public interface DeviceDisconnectedListener {
         ...
         * was reconnected. Once a device was reconnected, {@link Device#open(String)} should
     ...
     * {@link OpenNI#addDeviceStateChangedListener(DeviceStateChangedListener)}
     * function to add your listener object to OpenNI's list of listeners. Your handler function will
     * then be called whenever the event occurs. A
     * {@link OpenNI#removeDeviceStateChangedListener(DeviceStateChangedListener)}
     * function is also provided, if you want to have your class stop listening to these events for
     * any reason.
     */
     ...
     *
     * @param enabled Whether log entries should be redirected after printing to Android logs.
     */
    public static void setLogAndroidOutputRedirect(boolean enabled) {
        NativeMethods.checkReturnStatus(NativeMethods.oniSetLogAndroidOutputRedirect(enabled));
    }
