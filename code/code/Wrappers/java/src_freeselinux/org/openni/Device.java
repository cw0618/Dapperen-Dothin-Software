...
public class Device {
	...
	public boolean getDepthOptimizationEnabled() {
        ...
        /**
	 * Used to turn the device laser on and off.
	 * @param enable
	 */
	...
	public void setGain(int gain) {
		NativeMethods.checkReturnStatus(
				NativeMethods.oniDeviceSetProperty(getHandle(), NativeMethods.DEVICE_PROPERTY_GAIN, gain));
	}

	public	int getGain() {
		OutArg<Integer> val = new OutArg<Integer>();
		NativeMethods.checkReturnStatus(
				NativeMethods.oniDeviceGetIntProperty(getHandle(), NativeMethods.DEVICE_PROPERTY_GAIN, val));
		return val.mValue;
	}
