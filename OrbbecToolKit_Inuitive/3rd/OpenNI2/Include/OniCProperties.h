...
enum
{
    ...
    ONI_DEVICE_PROPERTY_FREQUENCY_MODE = 6,
    ONI_DEVICE_PROPERTY_SENSOR_ID = 7,
    ONI_DEVICE_PROPERTY_PLATFORM_VERSION = 8,
    ONI_DEVICE_PROPERTY_GENERAL_SERIAL_NUMBER = 9,
    ONI_DEVICE_PROPERTY_SEND_COMMAND = 10,
    ONI_DEVICE_PROPERTY_EMITTER_STATE = 50,
    ONI_DEVICE_PROPERTY_LOAD_FILE = 51,
    ONI_DEVICE_PROPERTY_CALIBRATION_CAMERA = 52,
    ONI_DEVICE_PROPERTY_QUERY_DEVICE_TIMESTAMP = 53,
    ONI_DEVICE_PROPERTY_START_SERVICE = 54,
    ONI_DEVICE_PROPERTY_TEMPERATURE_COEFFICIENT_RX = 55,
	...
	OBEXTENSION_ID_UPDATE_FRAMEMODE = 19,

    // Files
    ONI_DEVICE_PROPERTY_PLAYBACK_SPEED = 100, // float
    ONI_DEVICE_PROPERTY_PLAYBACK_REPEAT_ENABLED = 101, // OniBool

    ONI_DEVICE_PROPERTY_ENABLE_SUBTRACT_BG = 110,
    ONI_DEVICE_PROPERTY_STATE_SUBTRACT_BG = 111,
};
...
enum
{
	...
	ONI_STREAM_PROPERTY_LOAD_FILE=10,
    // Camera
