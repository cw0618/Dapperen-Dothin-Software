...
namespace openni
{
    ...
    */
    ...
    class CameraMatrix : private OniCameraMatrix
    {
    public:
        /**
        * Gives the resolution width of the calibration sensor.
        *
        ...
        */
        ...
        /**
        * Gives the resolution height of the calibration sensor.
        *
        ...
        */
        ...
        /**
        * Gives the intrinsic calibration data.
        *
        * @return Intrinsic data.
        */
        const OniCameraIntrinsics& getIntrinsics() const
        {
            return this->intrinsics;
        }

        /**
        * Gives the extrinsic calibration data.
        *
        * @return Extrinsic data.
        */
        const OniCameraExtrinsics& getExtrinsics() const
        {
            return this->extrinsics;
        }

    private:
        void setData(const OniCameraMatrix &rhs)
        {
            this->width = rhs.width;
            this->height = rhs.height;
            this->metric_radius = rhs.metric_radius;
            memcpy(&this->intrinsics, &rhs.intrinsics, sizeof(OniCameraIntrinsics));
            memcpy(&this->extrinsics, &rhs.extrinsics, sizeof(OniCameraExtrinsics));
        }

    private:
        friend class CalibrationCamera;
    };
    ...
    public:
        /**
        * Gives the color camera calibration data.
        *
        * @return Color calibration data.
        */
        const CameraMatrix& getCalibrationColor() const
        {
            return m_color;
        }

        /**
        * Gives the depth camera calibration data.
        *
        * @return Depth calibration data.
        */
        const CameraMatrix& getCalibrationDepth() const
        {
            return m_depth;
        }

    private:
        void setData(const OniCalibrationCamera &rhs)
        {
            m_color.setData(rhs.color);
            m_depth.setData(rhs.depth);
        }

    private:
        CameraMatrix m_color;
        CameraMatrix m_depth;
        friend class DeviceSettings;
    };

    class Metadata : public OniMetadata
    {
    public:
        Metadata()
        {
        ...
        Metadata(const OniMetadata& rhs)
        {
            set(rhs);
        }
        ...
        /**
        * Check if this object holds an actual metadata.
        *
        * @return bool
        */
        inline bool isValid() const
        {
            return (ONI_SENSOR_ID_NONE != this->id);
        }

        /**
        * Gives the ID of this sensor.
        *
        * @return Sensor ID.
        */
        inline SensorID getSensorID() const
        {
        ...
        */
        ...
        /**
        * Gives the group index of this frame.
        *
        * @return Group index.
        */
        ...
        /**
        * Gives the subframe index of this frame.
        *
        ...
        */
        ...
        /**
        * Indicates it is shuffle mode or not.
        *
        * @return true shuffle, false no shuffle.
        */
        ...
        /**
        * Gives the frame type of this frame.
        *
        * @return Frame type.
        */
        inline FrameType getFrameType() const
        {
            return (FrameType)this->type;
        }

        /**
        * Gives the TOF sensor mode of this frame.
        *
        * @return TOF sensor mode.
        */
        inline TOFSensorMode getSensorMode() const
        {
            return (TOFSensorMode)this->mode;
        }

        /**
        * Gives the low frequency of this frame.
        *
        * @return The low frequency.
        */
        inline int getLowFreq() const
        {
            return this->frequency[0];
        }

        /**
        * Gives the high frequency of this frame.
        *
        * @return The high frequency.
        */
        inline int getHighFreq() const
        {
            return this->frequency[1];
        }

        /**
        * Gives the integration time of low frequency of this frame.
        *
        * @return The integration time of low frequency.
        */
        inline int getLowIntegration() const
        {
            return this->integration[0];
        }

        /**
        * Gives the integration time of high frequency of this frame.
        *
        * @return The integration time of high frequency.
        */
        inline int getHighIntegration() const
        {
            return this->integration[1];
        }

        /**
        * Gives the duty cycle of low frequency this frame.
        *
        * @return The duty cycle of low frequency.
        */
        inline float getLowDutyCycle() const
        {
            return this->dutyCycle[0];
        }

        /**
        * Gives the duty cycle of high frequency this frame.
        *
        * @return The duty cycle of high frequency.
        */
        inline float getHighDutyCycle() const
        {
            return this->dutyCycle[1];
        }

        /**
        * Gives the TX temperature of this frame.
        *
        * @return TX temperature.
        */
        inline float getTemperTX() const
        {
            return this->temperTX;
        }

        /**
        * Gives the RX temperature of this frame.
        *
        * @return RX temperature.
        */
        inline float getTemperRX() const
        {
            return this->temperRX;
        }

        /**
        * Gives the delay circuit temperature of this frame.
        *
        * @return Delay circuit temperature.
        */
        inline float getTemperDelay() const
        {
            return this->temperDelay;
        }

    protected:
        inline void set(const OniMetadata& rhs)
        {
            this->id = rhs.id;
            this->width = rhs.width;
            this->height = rhs.height;
            this->mode = rhs.mode;
            this->type = rhs.type;
            this->shuffle = rhs.shuffle;
            this->frameIndex = rhs.frameIndex;
            this->groupIndex = rhs.groupIndex;
            this->temperTX = rhs.temperTX;
            this->temperRX = rhs.temperRX;
            this->temperDelay = rhs.temperDelay;
            this->frequency[0] = rhs.frequency[0];
            this->frequency[1] = rhs.frequency[1];
            this->dutyCycle[0] = rhs.dutyCycle[0];
            this->dutyCycle[1] = rhs.dutyCycle[1];
            this->integration[0] = rhs.integration[0];
            this->integration[1] = rhs.integration[1];
        }
        ...
        inline void reset()
        {
            ...
            this->temperTX = 0.0f;
            this->temperRX = 0.0f;
            this->temperDelay = 0.0f;
            this->frequency[0] = 0;
            this->frequency[1] = 0;
            this->dutyCycle[0] = 0.0f;
            this->dutyCycle[1] = 0.0f;
            this->integration[0] = 0;
            this->integration[1] = 0;
            this->shuffle = false;
            this->id = ONI_SENSOR_ID_NONE;
            this->type = ONI_FRAME_TYPE_NONE;
            this->mode = ONI_TOF_SENSOR_MODE_NONE;
        }

    private:
        friend class TOFFrame;
        friend class VideoFrameRef;
    };
    ...
    public:
        ...
        {
            return (m_pFrame->dataSize - m_pFrame->stride * m_pFrame->extraLine);
        }
        ...
        {
            return (static_cast<uint8_t*>(m_pFrame->data) + m_pFrame->stride * m_pFrame->extraLine);
        }

        /**
         * Getter function for the metadata of this frame.
         * @returns The metadata.
         */
        inline Metadata getMetadata() const
        {
            Metadata meta;
            if (m_pFrame->extraLine)
                meta.set(*(OniMetadata*)m_pFrame->data);
    ...
    protected:
        virtual inline void setReference(OniFrame* pFrame)
        {
    ...
    public:
        ...
        /**
         * Check if this object holds an actual joint.
         *
         * @return bool
         */
        inline bool isValid() const
        {
            return (ONI_JOINT_MAX != this->type);
        }

        /**
         * Gives the joint type. See the {@link JointType} for all possible values.
         *
         * @return Current joint type.
         */
        inline JointType getType() const
        {
            return (JointType)this->type;
        }

        /**
         * Gives the confidence of current joint.
         *
         * @return Current joint confidence.
         */
        ...
        /**
         * Gives the world coordinate of current joint.
         *
         * @return Current coordinate.
         */
        inline Point3D<double> getWorldCoordinate() const
        {
            Point3D<double> coordinate = { this->position.x, this->position.y, this->position.z};
            return coordinate;
        }

    protected:
        inline void set(const OniJoint& joint)
        {
            this->type = joint.type;
            this->score = joint.score;
    ...
    public:
        ...
        /**
         * Check if this object reference an actual frame.
         *
         * @return bool
         */
        inline bool isValid() const
        {
            return (this->id != INT32_MAX && (AI_STATUS_TRACKING == this->jointStatus || AI_STATUS_TRACKING == this->bodyShapeStatus));
        }

        /**
         * Gives the identity of the currently detected body.
         *
         * @return Current ID.
         */
        ...
        /**
         * Gives the status of body shape produced by this body frame.
         *
         * @return Body shape status.
         */
        inline AIStatus getBodyShapeStatus() const
        {
            return (AIStatus)this->bodyShapeStatus;
        }

        /**
         * Gives the height of the currently detected body.
         *
         * @return Current height.
         */
        inline float getBodyShapeHeight() const
        {
            return this->bodyShape.height;
        }

        /**
         * Gives the status of joints produced by this body frame.
         *
         * @return Joint status.
         */
        inline AIStatus getJointStatus() const
        {
            return (AIStatus)this->jointStatus;
        }

        /**
         * Gives the joint format. See the {@link PixelFormat} for all possible values.
         *
         * @return Current joint format (2D OR 3D).
         */
        inline PixelFormat getJointFormat() const
        {
            return (PixelFormat)this->jointFormat;
        }

        /**
         * Gives the current width of this body joint, measured in pixels per byte.
         *
         * @return Current width.
         */
        inline int getJointWidth() const
        {
            return this->jointWidth;
        }

        /**
         * Gives the current height of this body joint, measured in pixels per byte.
         *
         * @return Current height.
         */
        inline int getJointHeight() const
        {
            return this->jointHeight;
        }

        /**
         * Gives the number of joints produced by this body frame.
         *
         * @return Current size of joints.
         */
        int getJointSize() const
        {
            return ONI_JOINT_MAX;
        }

        /**
         * Gives the specified joint by index.
         *
         * @param index Index of joint linked list.
         *
         * @return The specified joint or invalid joint if such a joint is not available from this body frame.
         */
        Joint getJointByIndex(int index) const
        {
            Joint joint;
            if (index < 0 || index >= JOINT_MAX)
                return joint;

            joint.set(this->joints[index]);
            return joint;
        }
         ...
         * @return The specified joint or invalid joint if such a joint is not available from this body frame.
         */
        Joint getJointByType(JointType type) const
        {
            Joint joint;
            for (int i = 0; i < JOINT_MAX; ++i)
            {
                if (type == this->joints[i].type)
                    joint.set(this->joints[i]);
            }
    ...
    protected:
        inline void set(const OniBody& body)
        {
            this->id = body.id;
            this->jointWidth = body.jointWidth;
            this->jointHeight = body.jointHeight;
            this->jointFormat = body.jointFormat;
            this->jointStatus = body.jointStatus;
            this->bodyShape = body.bodyShape;
            this->bodyShapeStatus = body.bodyShapeStatus;
            for (int i = 0; i < JOINT_MAX; ++i)
            {
                this->joints[i] = body.joints[i];
            }
        }
        ...
        inline void reset()
        {
            ...
            this->jointWidth = 0;
            this->jointHeight = 0;
            this->jointStatus = ONI_AI_STATUS_NOT_TRACKING;
            this->jointFormat = ONI_PIXEL_FORMAT_NONE;
            this->bodyShapeStatus = ONI_AI_STATUS_NOT_TRACKING;
            memset(&this->bodyShape, 0, sizeof(OniBodyShape));
            for (int i = 0; i < JOINT_MAX; ++i)
            {
                this->joints[i].score = 0.0;
                this->joints[i].position.x = 0.0;
                this->joints[i].position.y = 0.0;
                this->joints[i].position.z = 0.0;
                this->joints[i].type = ONI_JOINT_MAX;
            }
        }

    private:
        friend class AIFrameRef;
    };

    class BodyMask : public OniBodyMask
    {
    public:
        BodyMask()
        {
        ...
        BodyMask(const OniBodyMask& rhs)
        {
            set(rhs);
        }
        ...
        /**
         * Check if this object holds an actual body mask.
         *
         * @return bool
         */
        inline bool isValid() const
        {
            return (0 != this->mask.width && 0 != this->mask.height && 0 != this->mask.address);
        }

        /**
         * Gives the current width of this body mask, measured in pixels per byte.
         *
         * @return Current width.
         */
        inline int getWidth() const
        ...
        /**
         * Gives the current height of this body mask, measured in pixels per byte.
         *
         * @return Current height.
         */
        inline int getHeight() const
         ...
         *
         * @return Current size measured in bytes.
         */
        inline int getDataSize() const
        {
            return this->mask.width * this->mask.height;
        }

        /**
         * Getter function for the array of data pointed to by this object.
         *
         * @return Pointer to the actual mask data array.
         */
        inline const void* getData() const
        {
            return (uint8_t*)this->mask.address;
        }

    protected:
        inline void set(const OniBodyMask& rhs)
        {
            this->status = rhs.status;
            this->mask.width = rhs.mask.width;
            this->mask.height = rhs.mask.height;
            this->mask.address = rhs.mask.address;
        }

        inline void reset()
        {
            this->status = ONI_AI_STATUS_NOT_TRACKING;
            this->mask.width = 0;
            this->mask.height = 0;
            this->mask.address = 0;
        }
    ...
    class FloorInfo : public OniFloorInfo
    {
    public:
        FloorInfo()
        {
        ...
        FloorInfo(const OniFloorInfo& rhs)
        {
            set(rhs);
        }
        ...
        /**
         * Check if this object holds an actual floor info.
         *
         * @return bool
         */
        inline bool isValid() const
        ...
        /**
         * Gives the three-dimensional center point of this floor plane.
         *
         * @return Current center coordinate.
         */
        inline Point3D<float> getPlaneCenter() const
        {
            Point3D<float> coordinate = { this->plane.center.x, this->plane.center.y, this->plane.center.z };
            return coordinate;
        }

        /**
         * Gives the three-dimensional normal vector point of this floor plane.
         *
         * @return Current normal vector coordinate.
         */
        inline Point3D<float> getPlaneNormal() const
        {
            Point3D<float> coordinate = { this->plane.normal.x, this->plane.normal.y, this->plane.normal.z };
            return coordinate;
        }

        /**
         * Gives the current width of this floor mask, measured in pixels per byte.
         *
         * @return Current width.
         */
        inline int getWidth() const
        ...
        /**
         * Gives the current height of this floor mask, measured in pixels per byte.
         *
         * @return Current height.
         */
        inline int getHeight() const
    ...
    protected:
        inline void set(const OniFloorInfo& rhs)
        {
            this->status = rhs.status;
            this->mask.width = rhs.mask.width;
            this->mask.height = rhs.mask.height;
            this->mask.address = rhs.mask.address;
            this->plane.center = rhs.plane.center;
            this->plane.normal = rhs.plane.normal;
        }
        ...
        inline void reset()
        {
            ...
            this->mask.height = 0;
            this->mask.address = 0;
            this->plane.center.x = 0.0f;
            this->plane.center.y = 0.0f;
            this->plane.center.z = 0.0f;
            this->plane.normal.x = 0.0f;
            this->plane.normal.y = 0.0f;
            this->plane.normal.z = 0.0f;
        }
    ...
    class TOFFrame : public OniTOFFrame
    {
    public:
        TOFFrame()
        {
        ...
        TOFFrame(const OniTOFFrame& rhs)
        {
            set(rhs);
        }
        ...
        /**
        * Check if this object holds an actual frame node.
        *
        * @return bool
        */
        inline bool isValid() const
        {
            return (0 != this->width && 0 != this->height && 0 != this->address && 0 != this->planeNum);
        }

        /**
        * Gives the number of planes of this frame node.
        *
        * @return number of planes.
        */
        inline int getPlaneNum() const
        {
            return this->planeNum;
        }

        /**
        * Gives the current width of this frame node, measured in pixels.
        *
        * @return Current width.
        */
        inline int getWidth() const
        ...
        /**
        * Gives the current height of this frame node, measured in pixels.
        *
        * @return Current height.
        */
        inline int getHeight() const
        ...
        * Primarily useful for indexing the array which contains the data.
        ...
        */
        ...
        /**
        * Getter function for the size of the data contained by this object, 
        * useful primarily when allocating buffers.
        *
        * @return Current size measured in bytes.
        */
        ...
        /**
        * Gives the metadata of this frame by index.
        * It should be noted that the index value cannot exceed the plane number.
        *
        * @return Metadata.
        */
        inline Metadata getMetadata(const int index) const
        {
            Metadata meta;
            if (index < 0 || index >= this->planeNum)
                return meta;

            meta.set(this->meta[index]);
            return meta;
        }

        /**
        * Getter function for the array of data pointed to by this plane.
        *
        * @return Pointer to the actual plane data array.
        */
        inline const void* getPlane(const int index) const
        {
            if (index < 0 || index >= this->planeNum)
                return NULL;

            return ((uint8_t*)this->address + index * getPlaneSize());
        }

    protected:
        inline void set(const OniTOFFrame& rhs)
        {
            this->width = rhs.width;
            this->height = rhs.height;
            this->stride = rhs.stride;
            this->address = rhs.address;
            this->planeNum = rhs.planeNum;
            memcpy(this->meta, rhs.meta, sizeof(rhs.meta));
        }
    ...
    private:
        friend class FrameSetRef;
    };

    class FrameSetRef : public OniFrameSet
    {
    public:
        FrameSetRef()
        {
        ...
        FrameSetRef(const OniFrameSet& rhs)
        {
            set(rhs);
        }
        ...
        /**
        * Check if this object holds an actual frame set.
        *
        * @return bool
        */
        inline bool isValid() const
        ...
        /**
        * Gives the size of this frame set.
        *
        * @return frame set size.
        */
        ...
        /**
        * Gives the TOF frame produced by this frame.
        *
        * @return frame of TOF sensor.
        */
        TOFFrame getTOFFrame(const FrameType& type) const
        {
            TOFFrame frame;
            if (type >= FRAME_TYPE_PHASE && type <= FRAME_TYPE_DEPTH)
                frame.set(this->frames[type]);

            return frame;
        }

    protected:
        inline void set(const OniFrameSet& rhs)
        {
            this->size = rhs.size;
            this->status = rhs.status;
            memcpy(this->frames, rhs.frames, sizeof(rhs.frames));
        }
    ...
    class AIFrameRef : public VideoFrameRef
    {
    public:
        AIFrameRef()
            : VideoFrameRef()
        ...
        {
            return m_pAIFrame->bodyList.num;
        }

        /**
         * Gives the specified body by index.
         *
         * @param index Index of body linked list.
         *
         * @return The specified body or invalid body if such a body is not available from this body frame.
         */
        Body getBodyByIndex(int index) const
        {
            Body body;
            if (index < 0 || index >= m_pAIFrame->bodyList.num)
                return body;

            body.set(m_pAIFrame->bodyList.bodies[index]);
            return body;
        }

        /**
         * Gives the specified body by ID.
         *
         * @param id Identity of the specified body.
         *
         * @return The specified body or invalid body if such a body is not available from this body frame.
         */
        ...
        {
            Body body;
            for (int i = 0; i < m_pAIFrame->bodyList.num; ++i)
            {
                if (m_pAIFrame->bodyList.bodies[i].id == id)
                {
                    body.set(m_pAIFrame->bodyList.bodies[i]);
                    break;
                }
            }
        ...
        /**
         * Gives the body mask produced by this frame.
         *
         * @return Body mask.
         */
        BodyMask getBodyMask() const
        {
            BodyMask mask;
            mask.set(m_pAIFrame->bodyMask);
            return mask;
        }

        /**
         * Gives the floor info produced by this frame.
         *
         * @return Floor info.
         */
        ...
        {
            FloorInfo info;
            info.set(m_pAIFrame->floorInfo);
            return info;
        }

        /**
        * Gives the frame set produced by this AI frame.
        *
        * @return frame set.
        */
        FrameSetRef getFrameSet() const
        {
            FrameSetRef frameSet;
            frameSet.set(m_pAIFrame->frameSet);
            return frameSet;
        }
    ...
    protected:
        virtual inline void setReference(OniFrame* pFrame)
        {
            VideoFrameRef::setReference(pFrame);
            m_pAIFrame = (OniAIFrame*)_getFrame()->data;
        }

    private:
        OniAIFrame* m_pAIFrame;
    };
    ...
    */
    ...
    public:
        ...
        */
        Device() : m_pDeviceSettings(NULL), m_pPlaybackControl(NULL), m_device(NULL), m_isOwner(true)
        {
            clearSensors();
        }
        ...
        */
        ...
        /**
        Gets an object through which several device settings can be configured.
        @returns NULL if this device has not yet been opened.
        */
        DeviceSettings* getDeviceSettings() { return m_pDeviceSettings; }
        ...
        */
        ...
        @deprecated Used @ref DeviceSettings instead.
        */
        ...
        */
        ...
        /**
        Get platform version number from this device.
        @param [out] pVersion Place allocated by the user to store the version number.
        @returns Status code indicating the success or failure of this operation.
        @deprecated Used @ref DeviceSettings instead.
        */
        Status getPlatformVersion(char* pVersion)
        {
            int length = ONI_MAX_STR;
            return getProperty(DEVICE_PROPERTY_PLATFORM_VERSION, pVersion, &length);
        }

        /**
        Get the current sensor ID.
        @param [in/out] type Sensor type (@see SensorType).
        @returns Sensor ID (@see SensorID).
        @deprecated Used @ref DeviceSettings instead.
        */
        SensorID getSensorID(const SensorType type)
        {
            OniSensorIDMap idMap = { (OniSensorType)type, ONI_SENSOR_ID_NONE };
            Status rc = getProperty<OniSensorIDMap>(DEVICE_PROPERTY_SENSOR_ID, &idMap);
            if (STATUS_OK != rc)
                return SENSOR_ID_NONE;

            return (SensorID)idMap.id;
        }

        /**
        Get the serial number from this device.
        @param [in/out] pSerialNumber Place to store the serial number.
        @returns Status code indicating the success or failure of this operation.
        @deprecated Used @ref DeviceSettings instead.
        */
        Status getSerialNumber(SerialNumberMap* pSerialMap)
        {
            return getProperty<OniSerialNumberMap>(DEVICE_PROPERTY_GENERAL_SERIAL_NUMBER, (OniSerialNumberMap*)pSerialMap);
        }

        /**
        Set the serial number to this device.
        @param [in] pSerialNumber Place to store the serial number to be written to the property.
        @returns Status code indicating the success or failure of this operation.
        @deprecated Used @ref DeviceSettings instead.
        */
        Status setSerialNumber(const SerialNumberMap* pSerialMap)
        {
            return setProperty<OniSerialNumberMap>(DEVICE_PROPERTY_GENERAL_SERIAL_NUMBER, *(const OniSerialNumberMap*)pSerialMap);
        }

        /**
        Get the current frequency mode on this device.
        @returns Current frequency mode (@see FrequencyMode).
        @deprecated Used @ref DeviceSettings instead.
        */
        FrequencyMode getFrequencyMode()
        {
            FrequencyMode mode = FREQUENCY_MODE_NONE;
            Status rc = getProperty<FrequencyMode>(DEVICE_PROPERTY_FREQUENCY_MODE, &mode);
            if (STATUS_OK != rc)
                return FREQUENCY_MODE_NONE;

            return mode;
        }

        /**
        Set frequency mode on this device.
        @param [in] freq Mode of frequency to be set (@see FrequencyMode).
        @returns Status code indicating the success or failure of this operation.
        @deprecated Used @ref DeviceSettings instead.
        */
        Status setFrequencyMode(FrequencyMode mode)
        {
            return setProperty<FrequencyMode>(DEVICE_PROPERTY_FREQUENCY_MODE, mode);
        }

        /**
        Send serial command to this device.
        @param [in] pCmd.cmd Place to store commands to be send to the device.
                             Support multiple commands, separated by commas.
        @param [out] pCmd.resp Place to store response string received from device.
        @returns Status code indicating the success or failure of this operation.
        @deprecated Used @ref DeviceSettings instead.
        */
        Status sendCommand(SerialCmd* pCmd)
        {
            return setProperty<OniSerialCmd>(DEVICE_PROPERTY_SEND_COMMAND, *(OniSerialCmd*)pCmd);
        }

        /**
        Get the current state of emitter on this device.
        ...
        */
        ...
        {
            int val = 0;
            Status rc = getProperty<int>(DEVICE_PROPERTY_EMITTER_STATE, &val);
            if (STATUS_OK != rc)
                return false;
        ...
        /**
        Enable or disable emitter on this device.
        @param [in] enable Emitter status to be set.
        @returns Status code indicating the success or failure of this operation.
        @deprecated Used @ref DeviceSettings instead.
        */
        Status emitterEnable(bool enable)
        {
            return setProperty<int>(DEVICE_PROPERTY_EMITTER_STATE, enable ? 1 : 0);
        }

        /**
        Load file to this device.
        @param [in] path The absolute path of the loaded file.
        @param [in] suffix Used to distinguish file types.
        @param [out] category Used to distinguish file category.
        @returns Status code indicating the success or failure of this operation.
        @deprecated Used @ref DeviceSettings instead.
        */
        Status loadFile(const char* path, const FileSuffix suffix = FILE_SUFFIX_BINARY, const FileCategory category = FILE_CATEGORY_COMMON)
        {
            OniFileAttributes attributes = { const_cast<char*>(path), static_cast<OniFileSuffix>(suffix), static_cast<OniFileCategory>(category) };
            return setProperty<OniFileAttributes>(DEVICE_PROPERTY_LOAD_FILE, attributes);
        }

        /**
        Query the current timestamp of the device system.
        @param [in] pTimestamp Place to store timestamp value.
        @returns Status code indicating the success or failure of this operation.
        @deprecated Used @ref DeviceSettings instead.
        */
        Status queryTimestamp(uint64_t *pTimestamp)
        {
            return getProperty(DEVICE_PROPERTY_QUERY_DEVICE_TIMESTAMP, pTimestamp);
        }
    ...
    private:
        DeviceSettings* m_pDeviceSettings;
    ...
    public:
        ...
        // @brief     Provides ID based on sensor type for this device.
        // @param[in] type The type of sensor whose ID needs to be queried.
        // @retval    SensorID object.
        // @note      The valid data will not be available until the device is opened.
        // @see       SensorID (a list of valid value return by this function).
        // @see       SensorType (a list of valid settings to pass to this function).
        const SensorID& getSensorID(const SensorType& type)
        {
            if (SENSOR_ID_NONE == m_id)
            {
                OniSensorIDMap idMap = { (OniSensorType)type, ONI_SENSOR_ID_NONE };
                getProperty<OniSensorIDMap>(DEVICE_PROPERTY_SENSOR_ID, &idMap);
                m_id = (SensorID)idMap.id;
            }

            return m_id;
        }

        // @brief     Provides serial number based on sensor type for this device.
        // @param[in] type The type of sensor whose serial number needs to be queried.
        // @retval    Serial number string.
        // @note      The valid data will not be available until the device is opened.
        // @see       SerialType (a list of valid settings to pass to this function).
        const char* getSerialNumber(const SerialType& type)
        {
            if ((OniSerialType)type != m_serial.type)
            {
                m_serial.type = (OniSerialType)type;
                getProperty<OniSerialNumberMap>(DEVICE_PROPERTY_GENERAL_SERIAL_NUMBER, &m_serial);
            }

            return m_serial.serial;
        }

        // @brief     Provides platform version number string for this device.
        // @param[in] 
        // @retval    Version number string of platform.
        // @note      The valid data will not be available until the device is opened.
        // @see
        const char* getPlatformVersion()
        {
            if (NULL == m_version)
            {
                int size = ONI_MAX_STR;
                m_version = new char[ONI_MAX_STR]();
                m_device->getProperty(DEVICE_PROPERTY_PLATFORM_VERSION, m_version, &size);
            }

            return m_version;
        }

        // @brief     Provides calibration data about this device in the form of a CalibrationCamera object.
        // @param[in]
        // @retval    CalibrationCamera object.
        // @note      The valid data will not be available until the device is opened.
        // @see       CalibrationCamera
        const CalibrationCamera& getCalibrationCamera()
        {
            if (NULL == m_calibration)
            {
                m_calibration = new CalibrationCamera();
                int size = sizeof(OniCalibrationCamera);
                OniCalibrationCamera calibration = { 0 };
                oniDeviceGetProperty(m_device->_getHandle(), ONI_DEVICE_PROPERTY_CALIBRATION_CAMERA, &calibration, &size);
                m_calibration->setData(calibration);
            }

            return *m_calibration;
        }

        // @brief     Checks to see if this device can support registration of color video and depth video.
        // @param[in] mode The way of image registration.
        // @retval    true if registration is supported, false otherwise.
        // @note      The valid data will not be available until the device is opened.
        // @see       ImageRegistrationMode (a list of valid settings to pass to this function).
        bool isImageRegistrationModeSupported(const ImageRegistrationMode& mode) const
        {
            return m_device->isImageRegistrationModeSupported(mode);
        }

        // @brief     Provides the current image registration mode for this device.
        // @param[in]
        // @retval    Current image registration mode.
        // @note      The valid data will not be available until the device is opened.
        // @see       ImageRegistrationMode for possible return values.
        ImageRegistrationMode getImageRegistrationMode() const
        {
            return m_device->getImageRegistrationMode();
        }

        // @brief     Provides the current working mode of TOF sensor for this device.
        // @param[in]
        // @retval    Current working mode.
        // @note      The valid data will not be available until the device is opened.
        // @see       FrequencyMode for possible return values.
        FrequencyMode getTOFWorkingMode() const
        {
            FrequencyMode mode = FREQUENCY_MODE_NONE;
            getProperty<FrequencyMode>(DEVICE_PROPERTY_FREQUENCY_MODE, &mode);
            return mode;
        }

        // @brief     Provides the current emitter state for this device.
        // @param[in]
        // @retval    true ON, false OFF.
        // @note      The valid data will not be available until the device is opened.
        // @see
        bool getEmitterState() const
        {
            int state = 0;
            getProperty<int>(DEVICE_PROPERTY_EMITTER_STATE, &state);
            return (1 == state ? true : false);
        }

        // @brief     Provides the current timestamp for this device.
        // @param[in]
        ...
        uint64_t getTimestamp() const
        {
            ...
            getProperty<uint64_t>(DEVICE_PROPERTY_QUERY_DEVICE_TIMESTAMP, &timestamp);
            return timestamp;
        }

        // @brief     Provides the temperature coefficient of RX for this device.
        // @param[in]
        // @retval    Temperature coefficient.
        // @note      The valid data will not be available until the device is opened.
        // @see
        double getTemperatureCoefficientRX() const
        {
            double coeff = 0.0f;
            getProperty<double>(DEVICE_PROPERTY_TEMPERATURE_COEFFICIENT_RX, &coeff);
            return coeff;
        }

        // Setters

        // @brief     Sets serial number based on sensor type on this device.
        // @param[in] type The type of sensor whose serial number needs to be set.
        // @param[in] serial A place to store the serial number to be set.
        // @retval    Status code indicating the success or failure of this operation.
        // @note      It is a good practice to make sure that the device is opened.
        // @see       SerialType (a list of valid settings to pass to this function).
        Status setSerialNumber(const SerialType& type, const char* serial)
        {
            if (NULL == serial || strlen(serial) >= ONI_MAX_STR)
                return STATUS_BAD_PARAMETER;

            OniSerialNumberMap map;
            map.type = (OniSerialType)type;
            strcpy(map.serial, serial);
            Status ret = setProperty<OniSerialNumberMap>(DEVICE_PROPERTY_GENERAL_SERIAL_NUMBER, map);
            if (STATUS_OK == ret)
                memcpy(&m_serial, &map, sizeof(OniSerialNumberMap));

            return ret;
        }

        // @brief     Sets the image registration on this device.
        // @param[in] mode Desired new value for the image registration mode.
        // @retval    Status code indicating the success or failure of this operation.
        // @note      It is a good practice to first check if the mode is supported by calling @ref
        //            isImageRegistrationModeSupported(), and make sure that the device is opened.
        // @see       ImageRegistrationMode (a list of valid settings to pass to this function).
        Status setImageRegistrationMode(const ImageRegistrationMode& mode)
        {
            return m_device->setImageRegistrationMode(mode);
        }

        // @brief     Sets the working mode of TOF sensor on this device.
        // @param[in] mode Desired new value for the TOF sensor working mode.
        // @retval    Status code indicating the success or failure of this operation.
        // @note      It is a good practice to make sure that the device is opened.
        // @see       FrequencyMode (a list of valid settings to pass to this function).
        Status setTOFWorkingMode(const FrequencyMode& mode)
        {
            return setProperty<FrequencyMode>(DEVICE_PROPERTY_FREQUENCY_MODE, mode);
        }

        // @brief     Sets the emitter state of TOF sensor on this device.
        // @param[in] enable true ON, false OFF.
        // @retval    Status code indicating the success or failure of this operation.
        // @note      It is a good practice to make sure that the device is opened.
        // @see
        Status setEmitterState(const bool enable)
        {
            return setProperty<int>(DEVICE_PROPERTY_EMITTER_STATE, enable ? 1 : 0);
        }

        // @brief     Sets the temperature coefficient of RX on this device.
        // @param[in] coeff Desired new value of temperature coefficient.
        // @retval    Status code indicating the success or failure of this operation.
        // @note      It is a good practice to make sure that the device is opened.
        // @see
        Status setTemperatureCoefficientRX(const double coeff)
        {
            return setProperty<double>(DEVICE_PROPERTY_TEMPERATURE_COEFFICIENT_RX, coeff);
        }

        // @brief     Load the file to this device.
        // @param[in] path The absolute path of file to be loaded.
        // @param[in] suffix The field used to distinguish file types.
        // @param[in] category The field used to distinguish file category.
        // @retval    Status code indicating the success or failure of this operation.
        // @note      It is a good practice to make sure that the device is opened.
        // @see       FileSuffix
        // @see       FileCategory
        Status loadFile(const char* path,
                        const FileSuffix suffix = FILE_SUFFIX_BINARY,
                        const FileCategory category = FILE_CATEGORY_COMMON)
        {
            OniFileAttributes attributes =
            {
                (char*)path,
        ...
        // @brief     Start the daemon process on the device side.
        // @param[in] type The field used to distinguish different daemons.
        // @param[in] state Daemon state to be set: ON or OFF.
        // @retval    Status code indicating the success or failure of this operation.
        // @note      It is a good practice to make sure that the device is opened.
        // @see       ServiceType
        // @see       ServiceState
        Status startService(const ServiceType& type, const ServiceState& state)
        {
            OniService service = { (uint16_t)type, (uint16_t)state };
            return setProperty<OniService>(DEVICE_PROPERTY_START_SERVICE, service);
        }

        // @brief      Send the serial command on this device.
        // @param[in]  cmd A place to store the commands which to be send to the device.
        //             Support multiple commands, separated by commas.
        // @param[out] resp A place to store response string received from this device.
        // @retval     Status code indicating the success or failure of this operation.
        // @note       It is a good practice to make sure that the device is opened.
        // @see
        Status sendSerialCmd(const char* cmd, char** resp)
        {
            if (NULL == cmd || strlen(cmd) >= ONI_MAX_STR)
                return STATUS_BAD_PARAMETER;

            *resp = m_command.resp;
            memset(&m_command, 0, sizeof(OniSerialCmd));
            strcpy(m_command.cmd, cmd);
            return setProperty<OniSerialCmd>(DEVICE_PROPERTY_SEND_COMMAND, m_command);
        }

    private:
        friend class Device;
        DeviceSettings(Device* pDevice)
            : m_device(pDevice)
            , m_id(SENSOR_ID_NONE)
            , m_version(NULL)
            , m_calibration(NULL)
        {
            m_serial.type = ONI_SERIAL_NONE;
            memset(m_serial.serial, 0, ONI_MAX_STR);
        }

        bool isValid() const { return NULL != m_device; }
        ...
        Status getProperty(int propertyId, T* value) const
        {
            ...
            return m_device->getProperty<T>(propertyId, value);
        }
        ...
        Status setProperty(int propertyId, const T& value)
        {
            ...
            return m_device->setProperty<T>(propertyId, value);
        }
    ...
    private:
        ...
        SensorID m_id;
        char* m_version;
        OniSerialCmd m_command;
        OniSerialNumberMap m_serial;
        CalibrationCamera* m_calibration;
    };
    ...
    */
    ...
    Status Device::_setHandle(OniDeviceHandle deviceHandle)
    {
        if (m_device == NULL)
        {
            ...
            if (NULL == m_pDeviceSettings)
            {
                m_pDeviceSettings = new DeviceSettings(this);
            }
